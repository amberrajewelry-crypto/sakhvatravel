...
BRANDS = {
    ...
    "VK","VKontakte","YouTube","UTC","GB","TBC","Bank","ALA","NQZ","Guda","Puris Sakhli","Puris","Sakhli","Fabrika","Idiot","UV","SPF","SPF50","ZIS","ZIS-110","Uzbekistan Airways","UZ","Air Astana","BYN","Belavia","Lonely","Planet","TBS","Toyota","Camry","BOG","Metromoney","Stambo","Vanilla","Sky","Vanilla Sky","Platanus","orientalis","Kapilamuris","Marani","CO",
