...
BRAND_RE = re.compile(r'\b(SAKHVA|TRAVEL|Sakhva|Timur|NOWPayments|WhatsApp|Telegram|'
    ...
    r'Magti|Geocell|Beeline|Silknet|Cellfie|ASAN|Airbnb|Mir|TBC|Bank|Ural|Airlines|Wings|'
    r'Koltsovo|Marjanishvili|Vake|Borjomi|Alazani|Dezerter|Gudauri|Balandino)\b')
