...
BRAND_RE = re.compile(r'\b(SAKHVA|TRAVEL|Sakhva|Timur|NOWPayments|WhatsApp|Telegram|'
    ...
    r'Koltsovo|Marjanishvili|Vake|Borjomi|Alazani|Dezerter|Gudauri|Balandino|Air Astana|BYN|Belavia|FlyOne|Armenia Airlines|Kilikia|Bagratashen|Sadakhlo)\b')
