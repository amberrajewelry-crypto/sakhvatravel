...
<a href="https://wa.me/995511272623?text=Хочу+забронировать+{slug.replace('-', '+')}" style="display:inline-flex;align-items:center;justify-content:center;gap:8px;background:#0E7C61;color:#fff;padding:13px 24px;border-radius:9999px;font-size:14px;font-weight:700;text-decoration:none;white-space:nowrap">
